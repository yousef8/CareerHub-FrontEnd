      ...
      <div class="card-body row align-items-center">
        ...
        <div class="col-md-12 col-sm-12"> 
          ...
          <div v-if="editing.email" class="mb-3">
            <input type="email" v-model="user.email" class="form-control mb-2" placeholder="Email">
            <button @click="updateProfile('email')" class="btn btn-primary mb-2">Save</button>
          </div>
          <div v-else>
            <div class="row">
              <div class="mb-3 col">
          ...
          <div v-if="editing.phone" class="mb-3">
            ...
            <button @click="updateProfile('phone_number')" class="btn btn-primary mb-2">Save</button>
          </div>
          <div v-else>
            <div class="mb-3">
              <div class="d-flex justify-content-between align-items-center">
...
export default {
  ...
  methods: {
    ...
    async updateProfile(key) {
      try {
        const response = await api.put('/user', { [key]: this.user[key] });
