<template>
    <div class="login-container d-flex align-items-center">
        <div class="login-form container p-3 text-dark bg-white">
            ...
            <p class="text-center">Didn't join CareerHub yet? <router-link to="/register">Sign up here</router-link></p>
            <form @submit.prevent="handleSubmit" class="d-flex flex-column align-items-center">
                ...
                <div class="my-1 w-75">
                    ...
                    <input v-model="password" type="password" id="password" class="form-control" pattern=".{8,}" title="Password must be at least 8 characters long" required>
                </div>
